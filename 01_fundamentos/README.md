...
* **[Git y GitHub para Data Engineers](git-y-github-para-data-engineers.md)**
  * Control de versiones en proyectos de datos
  * Flujo de trabajo con Git
  * Colaboración en GitHub
  * Buenas prácticas para Data Engineers

* **[Introducción a SQL](introduccion-sql.md)**
...
* **[Archivos .env para Data Engineers](archivos-env-para-data-engineers.md)**
...
* **[Docker para Data Engineers](docker-para-data-engineers.md)**
...
Una vez dominados los fundamentos, elige tu camino:

* **SQL primero**: Ve a **[02_sql](../02_sql/)** si quieres empezar con consultas y transformaciones
* **Python primero**: Ve a **[03_python](../03_python/)** si prefieres empezar con programación
