...
> 💡 **Ejemplo práctico**: Revisa el [notebook de Modelado Star Schema](../ejemplos/01-modelado-star-schema.ipynb) para ver estos conceptos en acción con código ejecutable.
...
Continúa con **[Calidad de datos](../calidad/calidad-de-datos.md)**.
