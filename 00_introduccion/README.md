...
* **[Roadmap para convertirte en Data Engineer](roadmap-data-engineer.md)**
...
* Explicar qué es Data Engineering en tus propias palabras
* Entender las diferencias entre roles en datos
* Tener claro tu roadmap de aprendizaje
* Saber qué habilidades desarrollar primero
