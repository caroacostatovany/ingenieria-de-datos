...
* Construir pipelines completos end-to-end
* Integrar múltiples tecnologías (SQL, Python, etc.)
* Aplicar buenas prácticas en proyectos reales
* Tener proyectos para tu portafolio
...
* **README.md**: Descripción, objetivos, requisitos
* **Código fuente**: Scripts y módulos organizados
* **Datos de ejemplo**: Para probar el pipeline
* **Documentación**: Explicación del diseño y decisiones
...
Antes de empezar los proyectos, asegúrate de dominar:

* **[01_fundamentos](../01_fundamentos/)**: Conceptos básicos
* **[02_sql](../02_sql/)** o **[03_python](../03_python/)**: Al menos uno
* **[05_pipelines](../05_pipelines/)**: Construcción de pipelines

---

## 🚀 Cómo usar estos proyectos

1. **Lee el README** del proyecto para entender el objetivo
2. **Revisa el código** y trata de entenderlo
3. **Ejecuta el proyecto** con los datos de ejemplo
4. **Modifica y experimenta** para aprender
5. **Adapta a tus necesidades** para tu portafolio
...
¿Tienes un proyecto que quieras compartir? Abre un Issue o Pull Request siguiendo nuestra [Guía de Contribución](../CONTRIBUTING.md).
